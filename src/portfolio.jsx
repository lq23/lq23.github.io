  ...
  return (
    <nav style={{
      ...
      >
        ...
        <span style={{ color: THEME.text }}>Larenz Quashie</span>
    ...
    <div style={{
      ...
      <AnimatedEntry delay={1.2} style={{
        ...
        <div style={{
          ...
          <span style={{
            fontFamily: "'JetBrains Mono', monospace", fontSize: 11,
            color: THEME.textDim, letterSpacing: "2px",
          }}>SCROLL</span>
          <div style={{
            width: 1, height: 24, background: `linear-gradient(to bottom, ${THEME.textDim}, transparent)`,
          }} />
        </div>
      </AnimatedEntry>
    </div>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <AnimatedEntry delay={0.3}>
          <div style={{
            ...
            {[
              { label: "Email", value: "larenzquashie406@gmail.com", icon: "✉", color: THEME.accent },
              { label: "GitHub", value: "github.com/lq23", icon: "◆", color: THEME.text },
              { label: "LinkedIn", value: "linkedin.com/in/larenzquashie/", icon: "▣", color: THEME.blue },
            ].map((link, i) => (
              <a
                key={link.label}
                href="#"
        ...
        <AnimatedEntry delay={0.45}>
          <div style={{
            ...
            <div style={{
              fontFamily: "'JetBrains Mono', monospace", fontSize: 12,
              color: THEME.textDim, marginBottom: 24,
              display: "flex", alignItems: "center", gap: 8,
            }}>
              <span style={{ width: 10, height: 10, borderRadius: "50%", background: THEME.danger }} />
              <span style={{ width: 10, height: 10, borderRadius: "50%", background: "#f59e0b" }} />
              <span style={{ width: 10, height: 10, borderRadius: "50%", background: THEME.accent }} />
              <span style={{ marginLeft: 12 }}>compose-message.sh</span>
            </div>
            ...
            {sent ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                <div style={{
                  ...
                  filter: `drop-shadow(0 0 20px ${THEME.accent}50)`,
                }}>✓</div>
                <p style={{ fontSize: 18, fontWeight: 600, marginBottom: 8, color: THEME.accent }}>Message sent!</p>
                <p style={{ color: THEME.textDim, fontSize: 14 }}>I'll get back to you soon.</p>
              </div>
            ) : (
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <button
                  ...
                  onMouseEnter={e => {
                    e.target.style.boxShadow = `0 0 50px ${THEME.accent}40`;
                    e.target.style.transform = "translateY(-2px)";
                  }}
                  onMouseLeave={e => {
                    e.target.style.boxShadow = `0 0 30px ${THEME.accent}25`;
                    e.target.style.transform = "translateY(0)";
                  }}
                >
                  Send Message →
