...
const FuzzyText = ({
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      const leftMargin = paddingLeft ?? fuzzRange + 20;
      const rightMargin = paddingRight ?? fuzzRange + 20;
      const verticalMargin = 0;
      canvas.width = offscreenWidth + leftMargin + rightMargin;
      canvas.height = tightHeight + verticalMargin * 2;
      ctx.translate(leftMargin, verticalMargin);

      const interactiveLeft = leftMargin + xOffset;
